...
<html lang="en">
 ...
 /* Output buffering is a way to tell php to hold some data before it is sent to the browser
    Then we can retrive the data and put it in a Variable, manipulate it and send it to the browser once we are finished*/

// Out buffering Start- turn on output buffering. it creates the buffer(invisible holding cell) that will store all after it is called.
    ob_start();
    // performing query
        ...
        // output content from the buffer and ends output buffering. It doesnot erase the buffer.
    ob_end_flush();
    include('header.php');
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5 bg-dark">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2022 - <?php echo $_SESSION['system']['name'] ?> | <a href="https://www.facebook.com/ros.shann.10" target="_blank">Roshan Bhagat</a></div></div>
        </footer>
